...
public class GoogleApiGatewayImpl implements GoogleApiGateway {
    ...
    @Override
    public void copyTemplate() throws GeneralSecurityException, IOException {
    ...
    private static Credential getCredentials(final NetHttpTransport HTTP_TRANSPORT) throws IOException {
        // Load client secrets.
        InputStream in = GoogleApiGatewayImpl.class.getResourceAsStream(CREDENTIALS_FILE_PATH);
